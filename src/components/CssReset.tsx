...
// Base page styling for the Storybook shell. Values are inlined (not read from a
// design-token package) so the harness carries no chart-engine dependency — v2
// stories bring their own theme via the viz-engine GraphProvider.
const MODERN_FONT_FAMILY = `'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', sans-serif`;

interface ResetStylesProps {
 ...
 */
export const ResetStyles = createGlobalStyle<ResetStylesProps>`
