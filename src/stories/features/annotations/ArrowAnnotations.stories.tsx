...
interface ArrowAnnotationsArgs {
  showShape: boolean;
...
const meta: Meta<ArrowAnnotationsArgs> = {
  title: 'Features/Annotations/Arrow Annotations',
...
export default meta;
type Story = StoryObj<ArrowAnnotationsArgs>;

const buildShapeAnnotations = (args: ArrowAnnotationsArgs): AnnotationItem[] => {
...
const buildArrowAnnotations = (args: ArrowAnnotationsArgs): AnnotationItem[] => {
...
const buildTextAnnotations = (args: ArrowAnnotationsArgs): AnnotationItem[] => {
...
const buildConfigAnnotations = (args: ArrowAnnotationsArgs): NonNullable<GraphConfig['annotations']> => {
...
const renderStory = (args: ArrowAnnotationsArgs) => <ArrowAnnotationsStory {...args} />;

const ArrowAnnotationsStory = (args: ArrowAnnotationsArgs) => {
